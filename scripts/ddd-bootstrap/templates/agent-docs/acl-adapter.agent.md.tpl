...
Role: external implementation packages for repositories, clients, publishers, subscribers, and security providers.

Adapters implement ports and must not reverse-depend on OHS remote packages.
